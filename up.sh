...
echo -e "  🏪 Portal de la Botillería: http://localhost:8083/tenant/"
echo -e "  ⚙️  Portal de Administración: http://localhost:8083/admin/"
echo -e "  📖 Swagger Docs:            http://localhost:8083/docs"
echo ""
