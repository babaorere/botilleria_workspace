...
class TestBackupScript:
    def test_backup_script_exists(self) -> None:
        backup_script = Path(
            "/home/manager/Sync/wildmill-proyects/botilleria_workspace/scripts/backup.sh"
        )
    ...
    def test_restore_script_exists(self) -> None:
        restore_script = Path(
            "/home/manager/Sync/wildmill-proyects/botilleria_workspace/scripts/restore.sh"
        )
    ...
    def test_monitoring_docker_compose_exists(self) -> None:
        compose_file = Path(
            "/home/manager/Sync/wildmill-proyects/botilleria_workspace/docker-compose.monitoring.yml"
        )
    ...
    def test_prometheus_config_exists(self) -> None:
        config_file = Path(
            "/home/manager/Sync/wildmill-proyects/botilleria_workspace/monitoring/prometheus/prometheus.yml"
        )
    ...
    def test_alert_rules_exist(self) -> None:
        rules_file = Path(
            "/home/manager/Sync/wildmill-proyects/botilleria_workspace/monitoring/prometheus/alert_rules.yml"
        )
    ...
    def test_grafana_dashboard_exists(self) -> None:
        dashboard_file = Path(
            "/home/manager/Sync/wildmill-proyects/botilleria_workspace/monitoring/grafana/dashboards/system-overview.json"
        )
